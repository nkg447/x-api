...
import com.apis.azure.speech.Synthesize;
...
@WebServlet(name = "GoogleSynthesizeServlet")
public class GoogleSynthesizeServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            try {
                ...
                System.out.println("GoogleSynthesizeServlet: response sent");
